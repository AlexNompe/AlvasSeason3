...
public class RawSilverItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:raw_silver")
	public static final Item block = null;

	public RawSilverItem(AlvasSeason3ModElements instance) {
		super(instance, 10);
	}
