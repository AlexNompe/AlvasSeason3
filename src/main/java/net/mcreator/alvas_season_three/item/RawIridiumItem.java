...
public class RawIridiumItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:raw_iridium")
	public static final Item block = null;

	public RawIridiumItem(AlvasSeason3ModElements instance) {
		super(instance, 9);
	}
