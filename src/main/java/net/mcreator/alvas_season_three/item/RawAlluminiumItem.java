...
public class RawAlluminiumItem extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:raw_alluminium")
	public static final Item block = null;

	public RawAlluminiumItem(AlvasSeason3ModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("raw_alluminium");
		}
