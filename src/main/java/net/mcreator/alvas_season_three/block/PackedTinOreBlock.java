...
public class PackedTinOreBlock extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:packed_tin_ore")
	public static final Block block = null;

	public PackedTinOreBlock(AlvasSeason3ModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("packed_tin_ore");
		}
