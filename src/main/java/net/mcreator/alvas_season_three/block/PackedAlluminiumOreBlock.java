...
import net.mcreator.alvas_season_three.item.AlluminiumIngotItem;
...
public class PackedAlluminiumOreBlock extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:packed_alluminium_ore")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("packed_alluminium_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlluminiumIngotItem.block));
		}
	}
}
