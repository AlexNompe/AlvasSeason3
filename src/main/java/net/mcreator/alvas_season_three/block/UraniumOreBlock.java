...
public class UraniumOreBlock extends AlvasSeason3ModElements.ModElement {
	@ObjectHolder("alvas_season_3:uranium_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("alvas_season_3:uranium_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 8)).range(8).square()
					.func_242731_b(1);
			event.getRegistry().register(feature.setRegistryName("uranium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("alvas_season_3:uranium_ore"), configuredFeature);
		}
	}
