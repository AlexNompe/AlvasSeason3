...
package net.mcreator.alvas_season_three.particle;
...
public class UraniumParticleParticle {
	public static final BasicParticleType particle = new BasicParticleType(false);

	@SubscribeEvent
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("uranium_particle"));
	}
